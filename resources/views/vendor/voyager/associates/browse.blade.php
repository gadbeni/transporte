                                ...
                                <thead>
                                    <tr>
                                        @if($showCheckboxColumn)
                                            <th class="dt-not-orderable" style="background-color:#098429">
                                        ...
                                        @endforeach
                                        <th style="background-color:#098429; color: white;"></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            <a href="{{ route('associates.showQrCode',$data->getKey())}}" class="btn btn-sm btn-warning" target="_blank">
